...
namespace btat7\ticTacToe\Controller;

    use btat7\ticTacToe\Model\Board as Board;
    ...
    use function btat7\ticTacToe\View\showGameBoard;
    use function btat7\ticTacToe\View\showMessage;
    use function btat7\ticTacToe\View\getValue;

    use const btat7\ticTacToe\Model\PLAYER_X_MARKUP;
    use const btat7\ticTacToe\Model\PLAYER_O_MARKUP;
